 ...
 */
public class QueryArtPersonalityGetty extends QuerySource implements QuerySourceInterface {

	private static Logger logger = Logger.getLogger(QueryArtPersonalityGetty.class);
	 ...
	 * Default constructor.
	 */
	public QueryArtPersonalityGetty () {
		super();
	}
